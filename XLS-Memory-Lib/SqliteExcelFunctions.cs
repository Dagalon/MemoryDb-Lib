...
public static class MemoryDbSqliteExcelFunctions
{
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.OPEN", Description = "Opens or creates a named SQLite in-memory connection, optionally from a database file path.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.ATTACH", Description = "Attaches a SQLite database file or in-memory database to an existing connection.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.DATABASES", Description = "Lists attached SQLite databases for a named connection.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.TABLES", Description = "Lists SQLite tables in the selected attached database.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.CREATE.TABLE", Description = "Creates a SQLite table from an Excel range. First row must contain headers.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.INSERT", Description = "Inserts rows into a SQLite table from an Excel range. First row must contain headers.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.EXECUTE", Description = "Executes a non-query SQL statement against a named SQLite connection.", Category = Category)]
    public static string Execute(string alias, string sql) => Relational.RelationalExecute(alias, sql, isDuckDb: false);

    [ExcelFunction(Name = "MEMDB.SQLITE.SCALAR", Description = "Executes a scalar SQL query against a named SQLite connection.", Category = Category)]
    public static object Scalar(string alias, string sql) => Relational.RelationalScalar(alias, sql, isDuckDb: false);

    [ExcelFunction(Name = "MEMDB.SQLITE.QUERY", Description = "Executes a SQLite query and spills the result as a two-dimensional array.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.DROP.TABLE", Description = "Drops a SQLite table from the selected attached database.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.SAVE", Description = "Saves an attached SQLite database to a file.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.CLOSE", Description = "Closes a named SQLite connection.", Category = Category)]
    ...
    [ExcelFunction(Name = "MEMDB.SQLITE.CLOSE.ALL", Description = "Closes all SQLite connections.", Category = Category)]
